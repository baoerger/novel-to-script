...
| Phase 9 — 测试 | PR-28 ~ PR-31 | 4 | 4 | 100% |
| Phase 10 — 部署 | PR-32 ~ PR-33 | 2 | 2 | 100% |
| **V1 小计** | | **33** | **33** | **100%** |
...
| PR | 分支名 | 目标 | 状态 | 依赖 |
|:---|--------|------|:---:|------|
| PR-46 | `pr-46-character-table` | 实现角色表格（搜索/筛选/排序） | ✅ | PR-45 |
...
| PR | 分支名 | 目标 | 状态 | 依赖 |
|:---|--------|------|:---:|------|
| PR-49 | `pr-49-frontend-docker` | 实现前端 Docker 集成 (docker-compose 全栈) | ✅ | PR-47 |
...
| **V1 小计** | | **33** | **33** | **100%** |
| | | | | |
| Phase 12 — 输入格式扩展 | PR-38 | 1 | 1 | 100% |
| Phase 13 — 质量体系 | PR-39 ~ PR-40 | 2 | 2 | 100% |
| Phase 15 — 前端基础 | PR-42 ~ PR-45 | 4 | 4 | 100% |
| Phase 16 — 前端交互编辑 | PR-46 ~ PR-47 | 2 | 2 | 100% |
| Phase 17 — 部署与导出增强 | PR-49 ~ PR-50 | 2 | 1 | 50% |
| **V2 小计** | | **11** | **10** | **91%** |
| **总计** | | **44** | **43** | **98%** |
...
| 2026-06-07 | PR-29 (解析器与分片器单元测试) 已合并 |
| 2026-06-07 | PR-30 (提取器与汇总器单元测试) 已合并 |
| 2026-06-07 | PR-31 (API 集成测试) 已合并 |
| 2026-06-07 | PR-32 (Dockerfile) 已合并 |
| 2026-06-07 | PR-33 (docker-compose) 已合并，V1 全部 33 个 PR 完成 |
| 2026-06-07 | 精简 V2: 砍掉 Phase 11/14、PR-48/PR-51；PR-46 降级为角色表格；V2 18→11 PR |
| 2026-06-07 | PR-38 (手动章节标注 API) 已合并 |
| 2026-06-07 | PR-39 (质检 Agent) 已合并 |
| 2026-06-07 | PR-40 (质量评估报告) 已合并，Phase 13 完成 |
